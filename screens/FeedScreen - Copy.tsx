...
return (
    ...
    return (
      <View style={{ position: 'absolute', top: 54, right: 12, backgroundColor: colors.card, borderColor: colors.border, borderWidth: 1, borderRadius: 12, padding: 12, zIndex: 9999, width: 260, shadowColor: '#000', shadowOpacity: 0.2, shadowOffset: { width: 0, height: 4 }, shadowRadius: 12 }}>
        ...
        <Pressable onPress={() => { close(); navigation.navigate('DesoUsers'); }} style={{ paddingVertical: 10 }}>
  <Text style={{ color: colors.text }}>DeSo users</Text>
</Pressable>
        ...
        <Pressable onPress={() => { close(); logout(); }} style={{ paddingVertical: 10 }}><Text style={{ color: '#f55', fontWeight: '700' }}>Logout</Text></Pressable>
